...
export const  tools = [
  { name: "Tailwind CSS", icon: MessengerSvg  },
  { name: "Figma", icon: FigmaSvg  },
  { name: "HTML5", icon: TechHtmlSvg  },
  { name: "React.js", icon: TechReactSvg  },
  { name: "Next.js", icon: SiNextdotjs   },
  { name: "Vue.js", icon: TechVue  },
  { name: "JavaScript", icon: TechJavaScSvg  },
  { name: "Webpack", icon: TechWebSvg  },
  { name: "Alpine.js", icon: TechAlpineSvg  },
];